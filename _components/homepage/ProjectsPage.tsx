  ...
  return (
    <>
      <div>
        ...
        <div className="flex mt-10 flex-col md:flex-row justify-center gap-6 mx-4">
      ...
      <div ref={projectsSectionRef} className="relative text-white mt-20">
        ...
        <div className="relative  z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mx-4">
          {projects.map((project, index) => (
            <div
              key={index}
              className="border  border-white bg-black p-4 flex flex-col h-[450px]"
            >
              <Image
                width={50}
                height={50}
          ...
          {selectedProject !== null && (
            <div className="flex flex-col justify-center h-full text-white relative">
              <button
                ...
                className="absolute top-6 right-6 bg-white text-black px-3 py-1 rounded hover:bg-gray-300 transition"
              >
                X
              </button>
              <Image
